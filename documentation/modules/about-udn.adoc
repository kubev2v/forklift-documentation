...
//
// * documentation/doc-Migrating_your_virtual_machines/machines/assemblies/assembly_advanced-migration-options.adoc
...
* link:{ocp-doc}/virtualization/networking#virt-connecting-vm-to-primary-udn[Connecting a virtual machine to a primary user-defined network]
