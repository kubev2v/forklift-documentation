...
+
<11> Optional:
* When set to `true`, {project-short} adds a random letter to the name of the PVC in order to ensure all PVCs have unique names. 
* When set to `false`, if you specify a `pvcNameTemplate`, {project-short} does not add a random letter to the name of the PVC.
+
