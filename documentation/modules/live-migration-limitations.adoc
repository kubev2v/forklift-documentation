...
* Live migration is available only for migrations between {virt} clusters. It is not available for any other source provider, whether the provider is supported by {product-first} or not. 
