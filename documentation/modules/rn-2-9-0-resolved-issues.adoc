...
//new entry
.{project-short} changed disk name of a virtual machine after migration from an OCP cluster to another OCP cluster
After you migrate a VMware guest VM to an OCP 4.18 cluster and then migrate that VM to another local OCP 4.18 cluster by using {project-short}, the disk names were changed. This issue has been resolved in {project-short} 2.9.0. link:https://issues.redhat.com/browse/MTV-2367[(MTV-2367)]
