...
.{project-short} does not refer to incorrect URL in the VDDK error message
...
.{project-short} changed disk name of a virtual machine after migration from an {ocp-short} cluster to another {ocp-short} cluster
