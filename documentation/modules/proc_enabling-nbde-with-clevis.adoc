...
[role="_abstract"]
When you enable NBDE with Clevis, the Tang server manages Linux Unified Key Setup (LUKS)-encrypted disk keys during migration. You can alternatively use manual LUKS passwords.
