...
[role="_abstract"]
Enable Network-Bound Disk Encryption (NBDE) with Clevis to manage keys for LUKS-encrypted disks. You can use NBDE or manual LUKS passwords during migration.
