...
[IMPORTANT]
====
{aws} {ec2} migration supports cold migration only. {ec2} instances must be stopped before migration begins.
====
...
// SME REVIEW: Are there any additional AWS-specific prerequisites for creating a migration plan?
...
+
// SME REVIEW: Screenshot needed - Virtual machines selection page for AWS EC2
+
// Network map page
