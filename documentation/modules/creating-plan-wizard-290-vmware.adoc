...
= Adding a VMware vSphere migration plan using the MTV wizard
...
* *Use an existing network map*: Select an existing network map from the list. These are network maps available for all plans. If you choose this option, a copy of this map will be attached to your plan and your plan will be the _owner_ of that copy. Any changes you make to your copy will not affect the original plan or any copies of it that other users have.
* *Create a new network map*: Allows you to create a new network map by supplying the following data. This map will be attached to this plan, which will then be considered to be its owner.

** *Source network* : Select from the list.
** *Target network* : Select from the list.
+
If needed, click *+* to add an additional mapping.
...
* *Use an existing storage map*: Select an existing storage map from the list. These are storage maps available for all plans. If you choose this option, a copy of this map will be attached to your plan and your plan will be the _owner_ of that copy. Any changes you make to your copy will not affect the original plan or any copies of it that other users have.
* *Create a new storage map*: Allows you to create one or two new storage map by supplying the following data. This maps will be attached to this plan, which will then be considered to be their owner. For each map, specify the following.
...
. When you finish reviewing the details of the plan, click *Create plan*. {project-short} validates your plan. After you correct all problems, click *Skip to review* and then click *Create plan*.
+
