...
+
To learn more about the different types of networks {ocp-short} supports, see {ocp-doc}/networking/index#additional-networks-provided_understanding-multiple-networks[Additional Networks in OpenShift Container Platform].
