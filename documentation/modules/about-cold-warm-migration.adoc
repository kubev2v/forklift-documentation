...
[role="_abstract"]
{project-first} supports cold migration from VMware vSphere, {rhv-full}, {osp}, OVAs created by VMware vSphere, and remote {virt} clusters. Warm migration is supported from VMware vSphere and {rhv-full} only.
