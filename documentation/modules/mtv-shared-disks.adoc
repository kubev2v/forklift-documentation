...
You can migrate VMware virtual machines (VMs) with shared disks by using the {project-first}. This functionality is supported only for cold migrations and is not supported for shared boot disks. 
