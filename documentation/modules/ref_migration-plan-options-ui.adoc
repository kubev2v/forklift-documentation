...
[IMPORTANT]
====
For successful migrations, {project-short} automatically deletes PVC mounts, conversion pods, and populator pods. For failed migrations, archiving is required to delete PVC mounts and release temporary resources.
====
