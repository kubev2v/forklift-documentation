...
** `"disk-{{.VolumeIndex}}"`
** `"pvc-{{.PVCName}}"`
<15> You can use either the `id` or the `name` parameter to specify the source VMs. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration fails.
...
<9> You can use either the `id` or the `name` parameter to specify the source VMs. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration fails.
...
<7> You can use either the `id` or the `name` parameter to specify the source VMs. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration fails.
