...
<3> Storage copy offload feature only: Name of the offload plugin you are using for this migration. Currently, the only valid value is `vmware XCOPY`.
