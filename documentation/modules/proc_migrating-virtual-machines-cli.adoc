...
.Prerequisites
* If you are using a user-defined network (UDN), have the name of its namespace as defined in {virt}.
...
.Prerequisites
* If you are using a user-defined network (UDN), have the name of the its namespace as defined in {virt}.
...
<5> If you are using a user-defined network (UDN), its namespace is denied in {virt}.
endif::[]
...
** `"disk-{{.VolumeIndex}}"`
** `"pvc-{{.PVCName}}"`
<15> You can use either the `id` or the `name` parameter to specify the source VMs. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration will fail.
...
<9> You can use either the `id` or the `name` parameter to specify the source VMs. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration will fail.
...
<7> You can use either the `id` or the `name` parameter to specify the source VMs. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration will fail.
