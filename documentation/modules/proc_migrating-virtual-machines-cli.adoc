...
<3> Storage copy offload feature only: Name of the offload plugin you are using for this migration. For example, a {vmw} vSphere plugin that supports `XCOPY`.
