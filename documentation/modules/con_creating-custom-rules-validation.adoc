...
[role="_abstract"]
The Validation service uses Open Policy Agent (OPA) rules to check VM migration suitability. It generates a list of concerns for each VM, which are stored in the `Provider Inventory` service as VM attributes and displayed in the web console.
