...
[role="_abstract"]
This section describes common issues that users encounter when planning and executing virtual machine migrations, and how to avoid or resolve them.
...
For more information about renaming VMs in the {project-short} UI, see xref:proc_renaming-vms-for-migration_{context}[Renaming virtual machines].

[role="_additional-resources"]
.Additional resources

* xref:ref_source-vm-migration-considerations_{context}[Source VM migration considerations]
