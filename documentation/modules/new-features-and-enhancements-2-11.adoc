...
Controlling nested virtualization in {vmw} migrations::

{vmw} only: In {project-short} 2.11.1, you can control nested virtualization behavior during migration with the new `enableNestedVirtualization` option. This option accepts three values:
