...
[id="proc_adding-migration-hook-via-cli_{context}"]
...
[NOTE]
====
You can set the service account directly in the {ocp} web console when creating or editing a migration plan by using the *Service account* field. See xref:proc_adding-migration-hook-via-ui_{context}[Adding a migration hook using the web console] for the simplified UI workflow. The CLI/YAML method documented here is still supported for advanced use cases and automation.
====
