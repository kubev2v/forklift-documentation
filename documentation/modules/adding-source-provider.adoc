...
ifdef::vmware[]
. Access the *Create VMware vSphere provider* interface by doing one of the following:

.. In the {ocp} web console, click *Migration > Providers*.
... Click *Create Provider*.
... Click *vSphere*.

.. In the {ocp} web console, click  *Migration > Overview*.
... Click *vSphere*.
...
ifdef::rhv[]
. Access the *Create {rhv-full} provider* interface by doing one of the following:
...
ifdef::ova[]
. Access the *Create OVA provider* interface by doing one of the following:
...
ifdef::ostack[]
. Access the *Create {osp} provider* interface by doing one of the following:
