...
+
. Optional:  Fetch the CA certificate from the provider's API endpoint URL and confirm the validity of the certificate manually. Once confirmed, the CA certificate will be used to validate subsequent communication with the API endpoint.
+
