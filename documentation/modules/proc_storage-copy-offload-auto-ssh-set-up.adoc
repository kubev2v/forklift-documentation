...
----
$ {oc} get secrets -l app.kubernetes.io/component=ssh-keys -n {namespace}
----
+
...
[source,terminal,subs="attributes+,+quotes"]
----
$ {oc} get secret <name_of_private_or_public_key> -o yaml -n {namespace}
----
+
...
$ {oc} create secret generic <name_of_private_key> \
  ...
  --dry-run=client -o yaml | {oc} replace -f - -n {namespace}
----
+
