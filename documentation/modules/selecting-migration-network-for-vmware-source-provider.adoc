...
You can select a migration network in the {project-short} web console for a VMware source provider to reduce risk to the source environment and to improve performance.
