...
[role="_abstract"]
You can add a migration hook to an existing migration plan by using the {ocp} web console. Note that you need to run one command in the {project-first} CLI.
