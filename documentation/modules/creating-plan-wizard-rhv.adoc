...
* Have a {rhv-full} source provider and {a-virt} destination provider. For more information, see xref:adding-source-provider_rhv[Adding a {rhv-full} source provider] or xref:adding-source-provider_dest_rhv[Adding {a-virt} destination provider].
