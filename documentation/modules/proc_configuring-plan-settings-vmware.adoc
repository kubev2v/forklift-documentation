...
* You have created a migration plan by using the {project-full} wizard. For more information, see xref:creating-plan-wizard-vmware_{context}[Creating a VMware vSphere migration plan by using the MTV wizard].
