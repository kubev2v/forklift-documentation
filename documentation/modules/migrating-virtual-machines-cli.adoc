...
<2> Specify the managed object reference (MOR) of the VMware host. To retrieve the MOR, see xref:retrieving-vmware-mor_{context}[Retrieving a VMware vSphere MOR].
...
<3> Specify the VMware network MOR, the {rhv-short} network UUID, or the {osp} network UUID. To retrieve the MOR, see xref:retrieving-vmware-mor_{context}[Retrieving a VMware vSphere MOR].
...
<2> Specify the VMware datastore MOR, the {rhv-short} storage domain UUID, or the {osp} `volume_type` UUID. For example, `f2737930-b567-451a-9ceb-2887f6207009`. To retrieve the MOR, see xref:retrieving-vmware-mor_{context}[Retrieving a VMware vSphere MOR].
+
[NOTE]
====
...
<9> Specify the VMware VM MOR, {rhv-short} VM UUID or the {osp} VM UUID. To retrieve the MOR, see xref:retrieving-vmware-mor_{context}[Retrieving a VMware vSphere MOR].
