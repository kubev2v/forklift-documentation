...
[id="proc_creating-plan-wizard-hyperv_{context}"]
= Creating a Microsoft Hyper-V migration plan by using the {project-short} wizard

[role="_abstract"]
You can migrate virtual machines (VMs) from Microsoft Hyper-V by using the {project-full} plan creation wizard.
...
. On the *Virtual machines* page, select the VMs you want to migrate and click *Next*.
