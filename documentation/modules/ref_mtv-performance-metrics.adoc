...
[role="_abstract"]
{project-short} provides performance metrics for system configuration and tuning. Network and storage throughput metrics are displayed during active migrations. All metrics are available for local monitoring and alerts.
