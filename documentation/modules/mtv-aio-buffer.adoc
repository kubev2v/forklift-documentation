...
[role="_abstract"]
You can change Network Block Device (NBD) transport Network File Copy (NFC) parameters for increased migration performance when using the {project-first} product.

[WARNING]
====
Using AIO buffering is only suitable for cold migration.
...
* vSphere : 7.0.3
* VDDK : 7.0.3
* For other VDDK and vSphere versions, check the AIO buffer support in the link:https://docs.vmware.com/[official VMware documentation].
