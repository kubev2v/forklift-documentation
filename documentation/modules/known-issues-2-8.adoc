...
.MTV does not list any VM which is part of a vApp
{project-short} does not list any VM which is part of a VMware vApp. link:https://issues.redhat.com/browse/MTV-1153[(MTV-1153)]