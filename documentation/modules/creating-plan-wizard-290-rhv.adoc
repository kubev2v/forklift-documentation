...
* If you are using a user-defined network (UDN), have the name of the namespace as defined in {virt}.
...
. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration will fail.
+
// Network map page
