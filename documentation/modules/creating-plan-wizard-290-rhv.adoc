...
. If you are using a UDN, verify that none of the IPs of the VMs are within the subnet of the UDN. If an IP of a VM is within the subnet of the UDN, the migration fails.
+
// Network map page
