...
Live migration is available only for {virt}. It migrates running VMs from one {virt} cluster to another without a noticeable service interruption. The VMs maintain their active state throughout the process. 
// Add link. 
