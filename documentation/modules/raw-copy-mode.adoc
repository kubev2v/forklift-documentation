...
* For information about configuring raw copy mode by using the command-line interface, see the `skipGuestConversion` and `useCompatibilityMode` parameters in xref:proc_migrating-virtual-machines-cli_vmware[Running a VMware vSphere migration from the command-line].
