...
* For information about configuring raw copy mode by using the {project-short} user interface, see link:{mtv-plan}assembly_planning-migration-vmware_mtv#configuring-plan-settings-vmware_vmware[Configuring VMware migration plan settings] in _Planning your migration to Red Hat {virt}_.
