...
----
+
. If you added VMware source providers to MTV 2.2 and also mapped to NFS on the OpenShift destination provider in MTV 2.2, upgrading to MTV 2.3 will make the VMware providers have a Critical state and the NFS mapping invalid. To fix these problems:
