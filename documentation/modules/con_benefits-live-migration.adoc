...
[id="con_benefits-live-migration_{context}"]
= Benefits of live migration

[role="_abstract"]
Use live migration to perform Day 2 operations like maintenance and workload balancing with minimal service disruption. You can migrate VMs between {virt} clusters and namespaces while they run, avoiding the need for scheduled downtime.
