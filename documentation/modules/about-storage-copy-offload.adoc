...
{project-first} 2.10.0 leverages this command as the basis for storage copy offload, which clones your VMs' data to the storage hardware instead of transmits it between {project-short} and {virt}. This improved migration saves both time an resources.
