...
* In the `KubeVirt` resource of both clusters in the `featureGates` of the YAML,`DecntralizedLiveMigration` appears. You must have `admin-cluster` privileges to set this label.
