...
[role="_abstract"]
Create network maps in {project-first} to map source networks to {virt} networks. There are two types of network maps: maps created for a specific migration plan and maps created for use by any migration plan.
