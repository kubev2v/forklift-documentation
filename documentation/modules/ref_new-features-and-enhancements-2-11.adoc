...
[id="new-features-and-enhancements-2-11-7_{context}"]
== {project-short} 2.11.7
...
----
+
link:https://issues.redhat.com/browse/MTV-5623[MTV-5623]
...
+
This enhancement simplifies complex workflow steps and reorganizes content for a better learning process. It also integrates with Red{nbsp}Hat OpenShift Lightspeed for dynamic guidance. As a result, you can learn and navigate the system more effectively.
+
