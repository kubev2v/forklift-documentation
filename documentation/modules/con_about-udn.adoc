...
[role="_abstract"]
Use a user-defined network (UDN) as your default network for migrations. UDNs are not supported for {ocp-short}-to-{ocp-short} migrations. You can configure UDNs in {virt} and specify them in migration plan mappings.
