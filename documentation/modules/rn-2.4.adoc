...
Previously, version 7 of VMware Virtual Disk Development Kit (VDDK) should have been used when creating the VDDK image. In this release, the VDDK image can also be created with version 8 of VDDK. VDDK 8 is recommended when migrating to OCP 4.13 or later. In order to migrate to OCP 4.12 or lower, VDDK 7 should be used.
