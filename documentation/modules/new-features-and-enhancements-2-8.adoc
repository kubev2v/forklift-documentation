...
+ 
** Persistent volume claim (PVC) name template used to generate PVC names in the target virtual machine (VM). 
** Volume name template used to generate volume interface names in the target VM.
** Network name template used to generate network interface names in the target VM.
