...
* {rhv-full} 
* {osp}
* Open Virtual Appliances (OVAs) that were created by {vmw} vSphere footnote:[OVA migration is validated for VMware-exported virtual machines. For third-party networking or security appliances, check with the vendor for native KVM/OpenShift images (QCOW2).]
