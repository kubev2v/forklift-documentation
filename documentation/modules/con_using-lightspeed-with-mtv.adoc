...
[IMPORTANT]
====
When using {lightspeed-short} with an external AI service provider, cluster information, logs, and resource details may be transmitted to that provider. Organizations handling sensitive data should evaluate whether external AI services align with their security and compliance requirements. For on-premises data processing, consider using Red Hat Enterprise Linux AI (RHEL AI) or Red Hat OpenShift AI.
====
