...
* *PVC name template*: Generates a persistent volume claim (PVC) name for a VM disk that overrides the template set in the plan.
+
...
*** Click the {kebab} menu of the VM.
*** Select *Edit PVC name template*.
*** Enter the template according to the instructions.
*** Click *Save*.

* *Volume name template*: Generates a volume interface name for a target VM that overrides the template set in the plan.
+
The template follows the Go template syntax and has access to the following variables:
...
* *Network name template*: Generates a network interface name for a target VM that overrides the template set in the plan.
+
The template follows the Go template syntax and has access to the following variables:
