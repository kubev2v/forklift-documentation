...
* *Target namespace*: Destination namespace to be used by all the migrated VMs, by default, this is the currently active namespace. To edit the namespace, click the *Edit* icon, choose a different target namespace from the list in the window that opens, and click *Save*.
