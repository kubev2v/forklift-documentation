...
In earlier releases of {project-short}, there was an issue when attempting migration the migration of a VM with two disks with two different OS installed in a dual-boot configuration. This issue has been resolved in {project-short} 2.7.8. link:https://issues.redhat.com/browse/MTV-1877[(MTV-1877)] 
