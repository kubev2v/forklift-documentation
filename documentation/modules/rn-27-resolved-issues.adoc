...
.Forklift-controller fails to reconcile plans and returns an HTTP 500 error

In earlier releases of {project-short}, the `forklift-controller` consistently failed to reconcile a plan, while returning an HTTP 500 error. This issue has been resolved in {project-short} 2.7.3. link:https://issues.redhat.com/browse/MTV-1600[(MTV-1600)]
