...
See descriptions for the following features that are included under Cross-Provider Features:
* Replaced Forms and Wizards with OpenShift Console Create and Edit pages link:https://issues.redhat.com/browse/MTV-615[(MTV-615)]
...
* OpenShift Console native SDK fetch, post, and delete calls link:https://issues.redhat.com/browse/MTV-365[(MTV-365)]
* Removed Cancel icon during Cutover stage link:https://issues.redhat.com/browse/MTV-449[(MTV-449)]
* {product-short} UI plugin uses only a dynamic plugin for SDK REST API fetch methods link:https://issues.redhat.com/browse/MTV-616[(MTV-616)]
