...
The table listing providers and their VMs has been remapped and improved to show the relevant fields for each provider. list:https://issues.redhat.com/browse/MTV-773[(MTV-773)]

..Date filter

Lists of CRS can be filtered by different criteria, including creation date. list:https://issues.redhat.com/browse/MTV-724[(MTV-724)]
