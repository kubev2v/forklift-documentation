...
In earlier releases of {project-short}, an empty bearer token was sufficient for authentication. This issue has been resolved in {project-short} 2.6.6. link:https://issues.redhat.com/browse/MTV-1377[(MTV-1377)]
