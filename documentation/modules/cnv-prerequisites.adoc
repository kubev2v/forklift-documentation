...
[role="_abstract"]
To migrate between {virt} clusters, verify that both clusters have matching MTV versions and the source uses {virt} 4.16 or later. You can migrate forward to newer {virt} versions if both are compatible with your MTV version.
