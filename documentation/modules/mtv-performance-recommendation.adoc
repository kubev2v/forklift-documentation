...
** Schedule the cut-over to be done at least 24 hours before the maintenance window. 
** Schedule the cut-over to the beginning of that maintenance window. 

+
This schedule should allow the last snapshots to be small enough, including only the changes from the last 15 minutes.
