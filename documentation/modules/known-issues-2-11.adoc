...
----
+
link:https://issues.redhat.com/browse/MTV-4497[4497]
...
Deleting network or storage maps causes the `forklift-controller` to shuts down unexpectedly, leaving the migration plan state as `Ready` and causing pods to continue running. 
+
