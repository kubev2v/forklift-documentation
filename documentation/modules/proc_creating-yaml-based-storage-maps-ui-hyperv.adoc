...
* `source`: Specify the Hyper-V storage identifier, such as the file path to the virtual hard drive (for example, `C:\VHDs\disk.vhdx`), a volume GUID path, or a storage pool name.
