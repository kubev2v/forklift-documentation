...
[role="_abstract"]
To ensure that your custom validation rules persist across pod restarts, scaling events, and {project-first} upgrades, deploy the rules by using a *ConfigMap* Custom Resource (CR) and reference the rules in the {project-short} CR.
