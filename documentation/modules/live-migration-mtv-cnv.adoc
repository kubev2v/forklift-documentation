...
[role="_abstract"]
Live migration is a joint operation between {project-first} and {virt} that leverages the strengths of {project-short} when you migrate virtual machines (VMs) from one {virt} cluster to another.
