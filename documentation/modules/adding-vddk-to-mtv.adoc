...
You can download the VMware Virtual Disk Development Kit (VDDK), build a VDDK image, and push the VDDK image to a private secure registry. You then add the VDDK image to the `v2v-vmware` config map.
