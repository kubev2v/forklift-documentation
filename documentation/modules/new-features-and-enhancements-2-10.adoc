...
* In {project-short} 2.10.0, you can migrate VMs that are running on B-tree file systems (Btrfs) to {virt} with support for OS conversion.
+
...
+
link:https://issues.redhat.com/browse/MTV-3566[(MTV-3566)]
...
+
link:https://issues.redhat.com/browse/MTV-2188[(MTV-2188)]
...
* {project-short} 2.10.0 supports the migration of Linux Unified Key Setup (LUKS) encrypted VMs by using Network Bound Disk Encryption (NBDE) with Clevis. With this update, you can migrate LUKS-encrypted VMs without rebooting the VMs to obtain a decryption key from the Clevis server. The Clevis server must be accessible from OpenShift. 
+
link:https://issues.redhat.com/browse/MTV-3395[(MTV-3395)]
...
* In {project-short} 2.10.0, you can migrate VMs to existing user-defined networks (UDNs). With this update, you can create UDNs and map a VM's source network to the UDN, and you can preserve the static IP addresses of source VMs that have assigned IPs. 
+
