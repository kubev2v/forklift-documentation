...
[role="_abstract"]
Configure {vmw} vSphere user permissions to allow {project-first} to access and migrate VMs. Privileges vary based on migration type and VM encryption status.
