...
[role="_abstract"]
Configure {vmw} vSphere user permissions to allow {project-short} to access and migrate VMs. Privileges vary based on migration type and VM encryption status.
