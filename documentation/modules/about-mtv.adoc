...
Live migration is available *_only_* for migrations between {virt} clusters. It requires {project-short} version 2.10 or later and {virt} version 2.20 or later. 
