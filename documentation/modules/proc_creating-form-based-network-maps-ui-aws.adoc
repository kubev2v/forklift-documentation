...
// SME REVIEW: Are there any AWS-specific network prerequisites?
...
// - Screenshot of the network map creation form for AWS EC2
// - Example AWS subnet ID format (e.g., subnet-abc123def456)
// - How users can locate their subnet IDs in the AWS Console or CLI
+
