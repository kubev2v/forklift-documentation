...
|cold migration , 10 VMs , ESXi 01-03 , Private Network footnoteref:[note2,Private Network refers to a non-Management network]
|2.6
|7.0.3
|20
|cold
...
|cold migration , 10 VMs , 1 ESXi(0203) , Default Network
|2.6.2
|7.0.3
|20
|cold
