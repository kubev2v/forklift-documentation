...
= Creating and running a migration plan based on VMs

Once you have a source provider and a destination provider, you can create and run a migration plan based on the VMs you want to migrate.
