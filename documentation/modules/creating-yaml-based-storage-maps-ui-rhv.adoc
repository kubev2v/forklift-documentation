...
* Have a {rhv-full} source provider and {a-virt} destination provider. For more information, see xref:proc_adding-source-provider_rhv[Adding a {rhv-full} source provider] or xref:proc_adding-source-provider_dest_cnv[Adding {a-virt} destination provider].
