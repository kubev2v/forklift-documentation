...
[role="_abstract"]
Perform live migration using the CLI. The live migration procedure is identical to other {virt} migration procedures except you must set the `type` label to `live` in the Plan custom resource (CR).
