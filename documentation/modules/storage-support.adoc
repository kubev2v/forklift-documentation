...
[NOTE]
====
When you migrate from OpenStack, the migration allocates persistent volumes without CDI. In these cases, you might need to adjust the file system overhead.
