...
However, migrations from {rhv-short} 4.3.11 were tested with {project-short} 2.3, and might work in practice in many environments using {project-short} {project-version}. In this case, we advise upgrading {rhv-full} Manager to the previously mentioned supported version before the migration to {virt}.
====
