...
// SME REVIEW NEEDED: Should there be a Prerequisites section here that includes:
// - Setting up the SMB share (or link to a procedure for this)
// - Exporting VMs to the SMB share (or clarify if this is automatic/manual)
