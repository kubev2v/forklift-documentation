...
[role="_abstract"]
You can set up storage copy offload by using the vSphere Installation on Bundle (VIB). This is the default method for running storage copy offload migrations.
