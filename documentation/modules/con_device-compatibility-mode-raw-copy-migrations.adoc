...
You can configure the compatibility mode setting when you create a migration plan. For more information, see xref:configuring-plan-settings-vmware_vmware[Configuring VMware migration plan settings].
