...
You can configure the compatibility mode setting when you create a migration plan. For more information, see link:{mtv-plan}assembly_planning-migration-vmware_mtv#proc_configuring-plan-settings-vmware_vmware[Configuring VMware migration plan settings].
