...
+
For more information, see link:https://docs.redhat.com/en/documentation/migration_toolkit_for_virtualization/2.12/html-single/planning_your_migration/index#proc_enabling-lightspeed-integration[Enabling the {lightspeed-full} integration] in _Planning your migration_.
...
* link:https://docs.redhat.com/en/documentation/migration_toolkit_for_virtualization/2.12/html-single/planning_your_migration/index#con_using-lightspeed-with-mtv[{lightspeed-full} integration with {project-short}]
