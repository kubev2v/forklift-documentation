...
{project-short} 2.5.6 can be deployed on {ocp-name} 4.15 clusters, with the resolution of two issues: 

* The Forklift operator includes a fix for the link:https://issues.redhat.com/browse/OCPBUGS-30095[Forklift operator failing on {ocp-name} 4.15]. 
* The console plugin includes a fix for the `match` property that was removed in {ocp-name} Web Console. link:https://issues.redhat.com/browse/MTV-952[(MTV-952)]
