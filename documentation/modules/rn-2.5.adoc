...
A vulnerability in the Node.js Package Manager (npm) IP package could allow an attacker to run code and obtain sensitive information. This issue has been resolved in {project-short} 2.5.6 by upgrading the package `node-ip` to version 2.0.1
