...
ith VMware vSphere source providers, Enterprise Master Secret (EMS) enforcement is disabled for migrations W to enable migrations from versions of vSphere that are supported by {project-short} but do not meet the 2023 FIPS requirements.
