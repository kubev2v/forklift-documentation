...
** The SSH is disabled.
+
*Solution*: Manually enable an SSH connection on the ESXi host using the commands in xref:proc_storage-copy-offload-manual-ssh-set-up_{context}[Setting up storage copy offload using manually generated SSH keys].
