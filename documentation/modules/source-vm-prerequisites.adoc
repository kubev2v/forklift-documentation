...
[role="_abstract"]
Source VM prerequisites for all migrations: unmount ISO images and CD-ROMs, ensure each NIC has an IPv4 or IPv6 address, and verify the operating system is certified and supported for guest OS conversions.
