...
* Do not change IP addresses, VLANs, and other network configuration settings before or during migration. The MAC addresses of the virtual machines (VMs) are preserved during migration.
