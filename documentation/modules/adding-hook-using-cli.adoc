...
[NOTE]
====
For instructions for creating a service account, see link:https://docs.openshift.com/container-platform/{ocp-version}/authentication/understanding-and-creating-service-accounts.html
====
...
[NOTE]
====
You can also use a `here` document - a file preceded and followed by `EOF` - to add instructions to encode a playbook inside a larger command:
