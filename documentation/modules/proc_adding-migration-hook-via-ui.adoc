...
[id="proc_adding-migration-hook-via-ui_{context}"]
= Adding a migration hook to a migration plan using the {ocp} web console

[role="_abstract"]
Add a migration hook to an existing migration plan by using the {ocp} web console. Optionally, specify a service account for the hook.
