...
:abstract-planning: Install the {project-first} Operator and configure {project-short} to plan a cold, warm, or live migration of virtual machines to Red Hat {virt} on an OpenShift platform. Map the source and destination infrastructure for your migration, including storage and networking, and create validation rules.
:user-guide-title: Installing and using {the-lc} {project-full}
:planning-guide-title: Planning your migration to Red Hat {virt} on an OpenShift platform
