...
:migrating-guide-title: Migrating your virtual machines to Red Hat {virt} by using the {project-full}
:subtitle: Migrating from VMware vSphere or {rhv-full} to Red Hat {virt}
:subtitle-migrating: Migrating virtual machines from VMware vSphere, {rhv-full} or {osp} platforms, or other platforms to Red Hat {virt} on an OpenShift platform
