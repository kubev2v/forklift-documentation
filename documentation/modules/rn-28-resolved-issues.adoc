...
.VMs with mutually exclsuive spec values as source VM and destination VM cannot be migrated
...
.Disk names are changed after migration
In earlier releases of {project-short}, migrating a VM that had disks with different buses resulted in disk names being changed after migration. This issue has been resolved in {project-short} 2.8.1. link: https://issues.redhat.com/browse/MTV-2266[(MTV-2266)]

.Canceling the migration of a virtual machine causes the Plan controller to loop forever
In earlier releases of {project-short}, if a the migration of a virtual machine (VM) was canceled, the scheduler of the Plan controller would endlessly reschedule it for migration. This issue has been resolved in {project-short} 2.8.1. link: https://issues.redhat.com/browse/MTV-2287[(MTV-2287)]
