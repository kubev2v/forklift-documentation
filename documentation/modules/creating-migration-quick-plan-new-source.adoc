...
= Creating and running a migration quick plan with a new source provider

You can create a new source provider as part of creating a migration _quick plan_.
...
. Create a source provider following the instructions in xref:adding-source-providers[Adding Source providers].
+
...
.. You can run the plan later by selecting it on the *Plans for virtualization* page and following the procedure in xref:running-migration-plan_mtv[Running Migration Plans].
