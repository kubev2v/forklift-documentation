...
For a complete list of available template functions, see link:{mtv-mig}assembly_migrating-from-vmware_mtv#con_mtv-template-utility_vmware[{project-short} template utility].
