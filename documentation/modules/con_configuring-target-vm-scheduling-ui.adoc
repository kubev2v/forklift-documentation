...
[id="con_configuring-target-vm-scheduling-ui_{context}"]
= Scheduling target VMs from the user interface

[role="_abstract"]
Use the {project-short} user interface in the {ocp} web console to migrate VMs to specific {virt} nodes or pods and schedule when VMs are powered on.
