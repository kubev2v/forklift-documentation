...
[role="_abstract"]
Cold migration is for shut-down VMs and works with {vmw} vSphere, {rhv-full}, {osp}, Open Virtual Appliances (OVAs), Microsoft Hyper-V, and remote {virt} clusters. Warm migration is for running VMs from {vmw} vSphere and {rhv-full}.
