...
If, at the time when a migration snapshot is scheduled, the user performs another snapshot operation on the source VM, the migration fails instead of waiting for the user's snapshot operation to finish. link:https://bugzilla.redhat.com/show_bug.cgi?id=2057459[(*BZ#2057459*)]
