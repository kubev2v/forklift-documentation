...
[NOTE]
====
If you archive and then delete a plan that was created by using the CLI, its Network Mapping and Storage Mapping information might remain visible in the UI. 
====
