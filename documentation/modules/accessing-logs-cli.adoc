...
You can access logs and information about custom resources (CRs) from the command ine by using the `must-gather` tool. You must attach a `must-gather` data file to all customer cases.
