...
* Have an {osp} source provider and {a-virt} destination provider. For more information, see xref:adding-source-provider_cnv[Adding a {ocp} source provider] or xref:adding-source-provider_dest_cnv[Adding {a-virt} destination provider].
