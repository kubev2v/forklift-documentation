...
[id="creating-yaml-based-storage-maps-ui-vmware_{context}"]
...
* `id`: Specify the VMware vSphere datastore moRef, for example, `f2737930-b567-451a-9ceb-2887f6207009`. For more information about retrieving the moRef, see link:{mtv-mig}assembly_migrating-from-vmware_mtv#retrieving-vmware-moref_vmware[Retrieving a {vmw} vSphere moRef] in _{migrating-guide-title}_.
