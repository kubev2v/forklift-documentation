...
[role="_abstract"]
Configure the post-migration power state of VMs to start up automatically, remain powered off, or preserve the source VM power state.
...
.Procedure
. Configure the power state for target VMs in the {project-short} UI.
