...
[role="_abstract"]
OVA migrations to {virt} require VMware vSphere files in NFS-shared directories. {project-short} supports both compressed `.ova` packages and extracted packages.
