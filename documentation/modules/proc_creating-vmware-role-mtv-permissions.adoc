...
. In the vCenter Server UI, create a role that includes the set of privileges described in the table in xref:ref_vmware-prerequisites_mtv[VMware prerequisites].
