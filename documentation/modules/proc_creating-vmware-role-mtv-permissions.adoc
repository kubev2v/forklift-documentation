...
[id="proc_creating-vmware-role-mtv-permissions_{context}"]
...
. In the vCenter Server UI, create a role that includes the set of privileges described in the tables in xref:ref_vmware-privileges_{context}[VMware privileges].
