...
EOF
----
* Allowed values for `accessMode` are `ReadWriteOnce` and `ReadWriteMany`.
* Specify the VMware vSphere datastore moRef for `id`. For example, `f2737930-b567-451a-9ceb-2887f6207009`. For more information about retrieving the moRef, see 'Retrieving a VMware vSphere moRef' in _Migrating your virtual machines to Red Hat {virt}_.
endif::[]
...
----
* Allowed values for `accessMode` are `ReadWriteOnce` and `ReadWriteMany`.
* Specify the {rhv-short} storage domain UUID for `id`. For example, `f2737930-b567-451a-9ceb-2887f6207009`.
endif::[]
...
----
* Allowed values for `accessMode` are `ReadWriteOnce` and `ReadWriteMany`.
* Specify the {osp} `volume_type` UUID for `id`. For example, `f2737930-b567-451a-9ceb-2887f6207009`.
endif::[]
