...
`<source_storage_id>`::
Specifies the Hyper-V storage identifier, such as the file path to the virtual hard disk (for example, `C:\VHDs\disk.vhdx`), a volume GUID path, or a storage pool name.
