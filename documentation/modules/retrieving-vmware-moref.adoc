...
[role="_abstract"]
When you migrate VMs with a VMware vSphere source provider by using {project-first} from the command line, you need to know the managed object reference (moRef) of certain entities in vSphere, such as datastores, networks, and VMs.
