...
You must download the VMware Virtual Disk Development Kit (VDDK), build a VDDK image, and push the VDDK image to your image registry. Later, you will need the VDDK init image path when adding a VMware source provider. 
