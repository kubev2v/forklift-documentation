...
[NOTE]
====
In order to migrate to {virt} 4.12 (or lower), version 7.0.3.2 of VDDK should be downloaded from link:https://developer.vmware.com/web/sdk/7.0/vddk[VMware VDDK version 7 download page] instead.
====
