...
Target VM scheduling in {project-short} derives from Kubernetes's support for xref:https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/[Assigning Pods to Nodes]. 
