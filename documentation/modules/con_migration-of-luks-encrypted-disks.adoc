...
[role="_abstract"]
Migrate VMs with LUKS-encrypted disks to {virt} by enabling Network-Bound Disk Encryption (NBDE) with Clevis or by manually adding passwords in your migration plan. 
