...
[role="_abstract"]
Migrate {vmw} VMs with Linux Unified Key Setup (LUKS) encrypted disks to {virt} by enabling Network-Bound Disk Encryption (NBDE) with Clevis or by manually adding passwords in your migration plan. 
