...
You can migrate virtual machines to {virt} with the {project-short} web console or the command line interface (CLI).

[id='migrating-vms-web-console_{context}']
=== Migrating virtual machines with the {project-short} web console

You can migrate virtual machines to {virt} with the {project-short} web console.
