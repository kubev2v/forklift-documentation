...
If you are performing more than 10 concurrent VM migrations from a single ESXi host, you must increase the NFC service memory of the host.
...
You can cancel a migration by using the {project-short} web console or the command line interface (CLI).
