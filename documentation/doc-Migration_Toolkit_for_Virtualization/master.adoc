...
* The _quick plan_ method, in which you choose a previously-defined source and target and {project-short} suggests a network mapping and a storage mapping, both of which you can edit. This method saves you time and effort. It is described in its own section, which follows the procedures for all of the steps in creating a migration plan.
...
include::modules/creating-and-running-a-migration-quick-plan.adoc[leveloffset=+2]
