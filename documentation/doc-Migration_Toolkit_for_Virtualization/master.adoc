...
Review the following prerequisites for to ensure that your environment is prepared for migration.

These prerequisites apply to all migrations. Any source provider-specific prerequisites are discussed in the section dedicated to that source provider.
