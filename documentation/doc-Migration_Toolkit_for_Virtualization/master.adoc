...
You can migrate virtual machines (VMs) to {virt} by using the {ocp} web console to:
...
You can create a migration plan by using the {ocp} web console by specifying a source provider, the virtual machines (VMs) you want to migrate, and other plan details.
