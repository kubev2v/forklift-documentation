...
ifeval::["{build}" == "downstream"]
[discrete]
include::modules/mtv-making-open-source-more-inclusive.adoc[leveloffset=+1]
endif::[]
...
include::modules/mtv-cold-warm-migration.adoc[leveloffset=+1]
include::modules/mtv-migration-speed-comparison.adoc[leveloffset=+2]

include::modules/mtv-about-cold-warm-migration.adoc[leveloffset=+2]
...
include::modules/mtv-storage-support.adoc[leveloffset=+2]

include::modules/mtv-network-prerequisites.adoc[leveloffset=+2]

include::modules/mtv-source-vm-prerequisites.adoc[leveloffset=+2]

include::modules/mtv-rhv-prerequisites.adoc[leveloffset=+2]

include::modules/mtv-openstack-prerequisites.adoc[leveloffset=+2]
...
include::modules/mtv-ostack-token-auth.adoc[leveloffset=+4]
include::modules/mtv-ostack-app-cred-auth.adoc[leveloffset=+4]

:!ostack:
:context: mtv
:mtv:

include::modules/mtv-vmware-prerequisites.adoc[leveloffset=+2]
include::modules/mtv-creating-vddk-image.adoc[leveloffset=+3]
include::modules/mtv-increasing-nfc-memory-vmware-host.adoc[leveloffset=+3]
include::modules/mtv-vddk-validator-containers.adoc[leveloffset=+3]
include::modules/mtv-ova-prerequisites.adoc[leveloffset=+2]

include::modules/mtv-compatibility-guidelines.adoc[leveloffset=+2]
...
:context: web
:web:
include::modules/mtv-installing-mtv-operator.adoc[leveloffset=+2]
...
include::modules/mtv-configuring-mtv-operator.adoc[leveloffset=+2]
include::modules/mtv-max-concurrent-vms.adoc[leveloffset=+3]
...
include::modules/mtv-adding-source-provider.adoc[leveloffset=+2]
include::modules/mtv-selecting-migration-network-for-vmware-source-provider.adoc[leveloffset=+2]
...
include::modules/mtv-adding-source-provider.adoc[leveloffset=+2]
include::modules/mtv-selecting-migration-network-for-virt-provider.adoc[leveloffset=+2]

:!dest_vmware:
:context: vmware
:vmware:

include::modules/mtv-creating-migration-plan-2-8.adoc[leveloffset=+2]

include::modules/mtv-running-migration-plan.adoc[leveloffset=+2]

include::modules/mtv-migration-plan-options-ui.adoc[leveloffset=+2]

include::modules/mtv-canceling-migration-ui.adoc[leveloffset=+2]
...
include::modules/mtv-non-admin-permissions-for-ui.adoc[leveloffset=+2]
:cli!:
:context: mtv
:mtv:
...
include::modules/mtv-new-migrating-virtual-machines-cli.adoc[leveloffset=+2]
include::modules/mtv-snip_vmware-permissions.adoc[]
include::modules/mtv-retrieving-vmware-moref.adoc[leveloffset=+3]
include::modules/mtv-canceling-migration-cli.adoc[leveloffset=+3]
...
include::modules/mtv-changing-precopy-intervals.adoc[leveloffset=+2]
...
include::modules/mtv-about-rego-files.adoc[leveloffset=+3]
include::modules/mtv-accessing-default-validation-rules.adoc[leveloffset=+3]
include::modules/mtv-creating-validation-rule.adoc[leveloffset=+3]
include::modules/mtv-updating-validation-rules-version.adoc[leveloffset=+3]
include::modules/mtv-retrieving-validation-service-json.adoc[leveloffset=+2]
...
include::modules/mtv-about-hooks-for-migration-plans.adoc[leveloffset=+3]
include::modules/mtv-adding-hook-using-ui.adoc[leveloffset=+3]
include::modules/mtv-adding-hook-using-cli.adoc[leveloffset=+3]

include::modules/mtv-upgrading-mtv-ui.adoc[leveloffset=+1]
...
include::modules/mtv-uninstalling-mtv-ui.adoc[leveloffset=+2]
include::modules/mtv-uninstalling-mtv-cli.adoc[leveloffset=+2]
...
include::modules/mtv-error-messages.adoc[leveloffset=+2]
include::modules/mtv-using-must-gather.adoc[leveloffset=+2]
...
include::modules/mtv-virt-migration-workflow.adoc[leveloffset=+3]
include::modules/mtv-virt-v2v-mtv.adoc[leveloffset=+3]
...
include::modules/mtv-collected-logs-cr-info.adoc[leveloffset=+3]
include::modules/mtv-accessing-logs-ui.adoc[leveloffset=+3]
include::modules/mtv-accessing-logs-cli.adoc[leveloffset=+3]
