...
{the} {project-first} enables you to migrate virtual machines from VMware vSphere to {virt}, an add-on to {ocp}. With {virt}, you can run and manage virtual machine workloads alongside container workloads.
