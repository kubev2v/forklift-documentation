...
[role="_abstract"]
Use the {project-short} user interface to migrate virtual machines (VMs) from {vmw} vSphere, {rhv-full} ({rhv-short}), {osp}, Open Virtual Appliances (OVAs) that were created by {vmw} vSphere, or {virt} clusters.
